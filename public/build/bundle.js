...
var app = (function () {
    ...
    const file$2 = "src/AudioPlayer.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(track, file$2, 32, 10, 585);
    			if (audio.src !== (audio_src_value = /*src*/ ctx[0])) attr_dev(audio, "src", audio_src_value);
    			audio.controls = true;
    			add_location(audio, file$2, 28, 6, 503);
    			add_location(div, file$2, 27, 2, 491);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [src, player, play, audio_binding];
    }

    class AudioPlayer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { src: 0, play: 2 });
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function onTimerDone() {
    		dispatch("timerDone", { text: `Hello ${new Date()}!` });
    	}
    	...
    	const onClick = () => {
    		...
    		if (intervalHandle) {
    			...
    			counter.update(value => ({ ...value, running: true }));
    			...
    			intervalHandle = setInterval(
    				() => {
    					...
    					counter.update(value => {
    						...
    						return { ...value, totalSeconds: newVal };
    					});

    					if (newVal <= 0) {
    						counter.update(value => ({ totalSeconds: maxSeconds, running: false }));
    						clearInterval(intervalHandle);
    						onTimerDone();
    					}
    				},
    	...
    	$$self.$inject_state = $$props => {
    		if ("maxSeconds" in $$props) maxSeconds = $$props.maxSeconds;
    		if ("counter" in $$props) $$invalidate(1, counter = $$props.counter);
    		if ("status" in $$props) $$invalidate(0, status = $$props.status);
    		if ("intervalHandle" in $$props) intervalHandle = $$props.intervalHandle;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$counter*/ 16) {
    			$$invalidate(3, seconds = Math.floor($counter.totalSeconds % 60).toString().padStart(2, "0"));
    		}

    		if ($$self.$$.dirty & /*$counter*/ 16) {
    			$$invalidate(5, minutes = Math.floor($counter.totalSeconds / 60).toString().padStart(2, "0"));
    		}

    		if ($$self.$$.dirty & /*$counter, minutes, seconds*/ 56) {
    			$$invalidate(0, status = $counter.running
    			? `${minutes}:${seconds}`
    			: "Click me to start");
    		}
    	};

    	return [status, counter, onClick, seconds, $counter, minutes];
    }
    ...
    function create_fragment(ctx) {
    	...
    	timer.$on("timerDone", /*onTimerDone*/ ctx[3]);
    	let audioplayer_props = { src };
    	audioplayer = new AudioPlayer({ props: audioplayer_props, $$inline: true });
    	/*audioplayer_binding*/ ctx[4](audioplayer);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 19, 1, 412);
    			add_location(div, file, 22, 1, 519);
    			attr_dev(main, "class", "svelte-1tky8bj");
    			add_location(main, file, 18, 0, 404);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		d: function destroy(detaching) {
    			...
    			/*audioplayer_binding*/ ctx[4](null);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const onTimerDone = $event => {
    		...
    		audioPlayer.play();
    		$$invalidate(2, myNode.innerText = "Heya", myNode);
    	};
    	...
    	function audioplayer_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			audioPlayer = $$value;
    			$$invalidate(1, audioPlayer);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("myNode" in $$props) $$invalidate(2, myNode = $$props.myNode);
    	};
    	...
    	return [name, audioPlayer, myNode, onTimerDone, audioplayer_binding, div_binding];
    }
